...
void Player::addSkillAdvance(skills_t skill, uint64_t count)
{
	...
	/*
	function onSkillProgress(player, skill, tries)
    print("Player", player:getName(), "added", tries, "tries to skill", skill)
    -- Additional logic, e.g., display effects or notifications
end
	*/
	g_creatureEvents->playerProgress(this, skill, count);
